...
public class Array3_problems {
	...
	// the given array, but rearranged so that every 3 is immediately 
	...
	// followed by a 5. Do not move the 4's, but every other 
	// number may move. The array contains the same number of 4's 
	...
	// split the array so that the sum of the numbers on one side 
	...
	// same group appears in reverse order. For example, the largest 
